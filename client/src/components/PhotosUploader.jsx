  ...
  return (
    <>
      ...
      <div className="grid gap-2 grid-cols-3 lg:grid:cols-6 md:grid-cols-4 mt-2">
          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 leftt-1 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <label className="h-32 cursor-pointer flex items-center justify-center gap-1 border bg-transparent rounded-2xl p-2 text-2xl text-gray-60">
          <input
            type="file"
            multiple
            className="hidden"
